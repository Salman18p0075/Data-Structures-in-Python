...
class Lecturer(Employee):
    ...
    def __str__(self):
        return "Lecturer:"+ " " + str(self.id) + " " + str(self.name)+ " " + (self.get_permanent_address())
